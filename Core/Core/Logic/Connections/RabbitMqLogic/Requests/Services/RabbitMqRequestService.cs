...
namespace Core.Logic.Connections.RabbitMqLogic.Requests.Services
{
    ...
    public class RabbitMqRequestService : IRabbitMqRequestService
    {
        ...
        private string DeclareResponseQueue()
        {
            ...
            channel.ExchangeDeclare(exchange: responseQueueName, type: ExchangeType.Direct);
            channel.QueueDeclare(queue: responseQueueName, durable: false, exclusive: false, autoDelete: false, arguments: null);
            channel.QueueBind(queue: responseQueueName, exchange: responseQueueName, routingKey: responseQueueName);
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            var routingKey = queueNameGenerator.GenerateRequestQueueName<TRequest>();
